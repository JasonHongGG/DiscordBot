...
ALARM_CONTROL_CHANNEL_ID = int(os.getenv("ALARM_CONTROL_CHANNEL_ID"))

# n8n 設定
N8N_WEBHOOK_URL = os.getenv("N8N_WEBHOOK_URL")
N8N_DISCORD_WEBHOOK_URL = N8N_WEBHOOK_URL + os.getenv("N8N_DISCORD_WEBHOOK_URL")
N8N_RAG_WEBHOOK_URL = N8N_WEBHOOK_URL + os.getenv("N8N_RAG_WEBHOOK_URL")
N8N_RAG_CHAT_WEBHOOK_URL = N8N_WEBHOOK_URL + os.getenv("N8N_RAG_CHAT_WEBHOOK_URL")
